...
<html>
    <head>
        ...
        <script type="text/javascript">
           function serachStops(str) {
              ...
              xmlhttp.open("GET","/php/stops/stopsTable.php?q="+str,true);
              xmlhttp.send();
            } 
        </script>
    </head>
    ...
    <body>
        ...
        <div id= "wrapper">
            ...
            <div class="table">
                <form method="POST" action="php/stops/delSelect.php">
                    <div id="tableInput"><p>Please Enter A Route-ID into the textbox above!</p></div>
                    <input type="submit" class="button" name="enter" value="Delete">
                </form>
            </div>
        </div>
